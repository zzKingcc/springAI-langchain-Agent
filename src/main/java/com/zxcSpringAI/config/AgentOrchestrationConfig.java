 ...
 * Agent 编排配置
 *
 * <p>创建 AgentOrchestrationService Bean，注入流式模型、会话记忆、工具集、系统提示词、检查点持久化。
...
public class AgentOrchestrationConfig {
    ...
    public AgentOrchestrationService agentOrchestrationService(
        ...
        return new AgentOrchestrationService(streamingChatModel, chatMemoryProvider, tools, systemMessage, checkpointSaver, cancellationTracker);
    }
}
